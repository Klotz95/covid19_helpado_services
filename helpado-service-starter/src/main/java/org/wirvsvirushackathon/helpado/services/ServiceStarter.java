...
public class ServiceStarter extends Application<ServiceConfiguration> {
    ...
    public void run(ServiceConfiguration serviceConfiguration, Environment environment) throws Exception {
        ...
        OrderService orderService = new OrderService(orderStorage, sessionManager, userStorage);
    ...
    private void configureCors(Environment environment) {
        ...
        cors.setInitParameter(CrossOriginFilter.ALLOWED_HEADERS_PARAM, "X-Requested-With,Content-Type,Accept,Origin,Authorization,X-Session-Token,X-User-Id");
